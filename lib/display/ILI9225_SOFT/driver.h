...
class ILI9225_SOFT {
protected:
  virtual const uint8_t R() const = 0;
...
public:
  ...
  void init()
  {
    ...
    send_command(ILI9225_POWER_CTRL1);              send_word(0x0000);
    send_command(ILI9225_POWER_CTRL2);              send_word(0x0000);
    send_command(ILI9225_POWER_CTRL3);              send_word(0x0000);
    send_command(ILI9225_POWER_CTRL4);              send_word(0x0000);
    send_command(ILI9225_POWER_CTRL5);              send_word(0x0000);

    delay_ms(50);

    send_command(ILI9225_POWER_CTRL2);              send_word(0x0018);
    send_command(ILI9225_POWER_CTRL3);              send_word(0x6121);
    send_command(ILI9225_POWER_CTRL4);              send_word(0x006F);
    send_command(ILI9225_POWER_CTRL5);              send_word(0x495F);
    send_command(ILI9225_POWER_CTRL1);              send_word(0x0800);

    delay_ms(10);

    send_command(ILI9225_POWER_CTRL2);              send_word(0x103B);
