...
#define INIT(	X ) static void __attribute__ ((naked, used, section (".init" #X ))) __init ## X (void)
...
#define FINI(	X ) static void __attribute__ ((naked, used, section (".fini" #X ))) __fini ## X (void)
...
#define RAM_RO     __attribute__((__progmem__))
